...
import verifyAuth from "../utils/VerifyAuth.jsx";
...
const url = "https://medhistory-be.herokuapp.com/login/";
const SignIn = () => {
      ...
      <Layout className="layout-default layout-signin">
        <Header>
          <div className="header-col header-brand">
            <img src={Logo} alt="logo MedHistory" width={300} />
          </div>
        ...
        <Content className="signin">
          <Row gutter={[24, 0]} justify="space-around">
            <Col
              ...
              md={{ span: 12 }}
            >
              <Title className="mb-15">Inicie Sesión</Title>
              <Title className="font-regular text-muted" level={5}></Title>
              <Form
                onFinish={onFinish}
